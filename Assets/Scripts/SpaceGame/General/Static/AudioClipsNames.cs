...
{
    public static class AudioClipsNames

    {
        private static string _selection = "Selection";
        private static string _shoot = "Shoot";
        private static string _hit = "Hit";
        private static string _destroy = "Destroy";
        ...
        public static string Destroy => _destroy;
